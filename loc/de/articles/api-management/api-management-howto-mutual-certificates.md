...
Click **Sicherheit** aus der **API-Management** menu on the left, and click **Client certificates**.
...
Click **APIs** aus der **API-Management** menu on the left, click the name of the desired API, and click the **Sicherheit** tab.

![API security][api-management-api-security]

Select **Mutual certificates** aus der **With credentials** drop-down list.
