...
The scenarios covered include **constructing email**, **sending email**、と **adding attachments**. For more information on SendGrid and sending email, see the [次のステップ][] セクション。
...
詳細については、次を参照してください。 [https://sendgrid.com][].

## <a name="bkmk_CreateSendGrid"> </a>Create a SendGrid Account

[AZURE。含まれます [sendgrid-sign-up](../includes/sendgrid-sign-up.md)]
...
<span class="auto-style2">Swift\_Mailer::send</span> メソッドです。
