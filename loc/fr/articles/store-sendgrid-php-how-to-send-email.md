...
The scenarios covered include **constructing email**, **sending email**, et **adding attachments**. For more information on SendGrid and sending email, see the [Prochaines étapes][] section.
...
[AZURE. INCLURE [sendgrid-sign-up](../includes/sendgrid-sign-up.md)]
...
## <a name="bkmk_NextSteps"> </a>Prochaines étapes
