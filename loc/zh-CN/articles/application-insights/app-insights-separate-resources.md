...
To avoid mixing up telemetry from debugging, test, and production versions of your app, create separate [应用程序的见解][start] resources to receive the data from each version.
