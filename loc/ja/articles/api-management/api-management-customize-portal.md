...
The developer portal is based on a Content Management System or CMS. The header that appears on every page is a special type of content known as a widget. To edit the contents of that widget click **Widgets** から、 **Developer Portal** menu on the left, and then select the **Header** widget from the list.
...
The colors, fonts, sizes, spacings and other style-related elements of any page on the portal are defined by style rules. To edit the styles click on **Appearance** から、 **Developer portal** menu in the Publisher portal. Then click on **Begin customization** to enable the styling editor.
