...
To edit style rules, click on **Appearance** aus der **Developer portal** menu in the Publisher portal. Then click on **Begin customization** to enable the styling editor.
