...
# Verwenden Sie Twilio für Sprach- und SMS-Funktionen in PHP
...
**Twilio Stimme** können Ihre Anwendungen Telefon Anrufe tätigen und empfangen. **Twilio SMS** ermöglicht Ihrer Anwendung zum Senden und empfangen von SMS-Nachrichten. **Twilio Client** können Sie VoIP-Anrufe von jedem Telefon, Tablet, oder Browser vornehmen und WebRTC unterstützt.

## <a id="Pricing"></a>Twilio Preise und Sonderangebote

Himmelblau-Kunden erhalten eine [Sonderangebot](http://www.twilio.com/azure): gratis $10 Twilio Kredit, wenn Sie Ihr Twilio-Konto aktualisieren. Dieses Twilio-Guthaben kann auf eine Twilio Nutzung ($10 Guthaben gleichbedeutend mit mehr als 1.000 SMS-Nachrichten senden oder empfangen von bis zu 1000 eingehenden Voice-Minuten, je nach Lage Ihres Telefon-Nummer und Nachricht oder Anruf-Ziels) angewendet werden. Diese Twilio-Gutschrift einlösen und loslegen bei: [http://Ahoy.twilio.com/Azure](http://ahoy.twilio.com/azure).

Twilio ist ein Umlageverfahren Service. Es gibt keine Setup-Gebühren, und Sie können Ihr Konto jederzeit schließen. Hier finden Sie nähere Infos unter [Twilio Preise][twilio_pricing].
...
Detailed instructions for building and deploying a Twilio/PHP application to Azure are available at [Gewusst wie: Verwenden von Twilio in eine PHP-Anwendung auf Azure telefonieren][howto_phonecall_php].
...
For additional information about using Twilio in Azure with PHP, see [Gewusst wie: Verwenden von Twilio in eine PHP-Anwendung auf Azure telefonieren][howto_phonecall_php].
...
## <a id="NextSteps"></a>Die nächsten Schritte
