...
Click **Sicherheit** aus der **API-Management** menu on the left and click **External Identities**.
...
For **Sign-on URL**, copy the **Redirect URL** aus der **Azure Active Directory** section of the **External Identities** tab in the publisher portal and remove the **-aad** suffix from the end of the URL. In this example, the **Sign-on URL** ist `https://aad03.portal.current.int-azure-api.net/signin`. 
...
Copy the **Redirect URL** aus der **Azure Active Directory** section of the **External Identities** tab in the publisher portal and paste it into the **Reply URL** text box. 
