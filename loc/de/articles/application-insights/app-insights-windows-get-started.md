...
* [**Verwendung**][windowsUsage] - Learn how many users you have and what they are doing with your app.
...
Nutzung der [API][api] to send events, metrics and diagnostic data to Application Insights. In summary:
