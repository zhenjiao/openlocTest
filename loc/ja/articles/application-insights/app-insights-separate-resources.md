...
To avoid mixing up telemetry from debugging, test, and production versions of your app, create separate [アプリケーションのインサイト][start] resources to receive the data from each version.
