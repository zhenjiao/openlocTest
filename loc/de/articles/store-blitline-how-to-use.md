...
[AZURBLAU. ENTHALTEN [blitline-signup](../includes/blitline-signup.md)]
...
The Application ID is something you can find in your **CONNECTION INFO** oder **MANAGE** tab on Azure. It is your secret identifier that allows you to run jobs on Blitline.
...
You can also read the latest edition of Blitline's Azure Storage docs [Hier](http://www.blitline.com/docs/azure_storage).
