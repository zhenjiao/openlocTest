...
2. Select **アクティブ ディレクトリ** from the left pane.
...
For **APP ID URI**, provide the URI that identifies your application. The uniqueness or existence of the endpoint is not validated. Click the **完了します。** to create you AAD Application.
