...
Click **Notifications** 从 **API 管理** menu on the left to view the available notifications.
...
To view and configure the email templates for your API Management instance, click **Notifications** 从 **API 管理** menu on the left, and select the **Email Templates** tab.
...
的 **Parameters** list contains a list of parameters, which when inserted into the subject or body, will be replaced the designated value when the email is sent. To insert a parameter, place the cursor where you wish the parameter to go, and click the arrow to the left of the parameter name.

Click **Preview** 或 **Send a test** to see how the email will look or send a test email.
