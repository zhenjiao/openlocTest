...
Within the resource to create multiple times, you can define a **副本** object that specifies the number of times to iterate. The copy takes the following format:
