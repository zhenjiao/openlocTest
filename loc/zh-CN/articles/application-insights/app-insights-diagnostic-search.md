...
Diagnostic Search is the blade in [应用程序的见解][start] that you use to find and explore individual telemetry items, such as page views, exceptions, or web requests. And you can view log traces and events that you have coded.
...
term|is *不* matched by|but these do match
---|---|---
HomeController.About|about<br/>home|h\*关于<br/>home\*
IsLocal|local<br/>是<br/>\*local|isl\*<br/>islocal<br/>i\*l\*
...
* Capture log traces from your favorite logging framework in [.NET][netlogs] 或 [Java][javalogs]. This means you can search through your log traces and correlate them with page views, exceptions, and other events. 
