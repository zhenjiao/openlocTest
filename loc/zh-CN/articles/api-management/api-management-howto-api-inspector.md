...
>If you haven't yet created an API Management service instance, see [Create an API Management service instance][] 在 [Get started with Azure API Management][] tutorial.
...
By default in the developer portal the **Ocp-Apim-Trace** header is already set to **真正的**. This header configures whether or not a trace is generated.
