...
Azur clients reçoivent un [offre spéciale] 10 $ de Twilio crédit lorsque vous mettez à niveau votre compte Twilio. Ce Twilio crédit peut être appliqué à n'importe quel usage Twilio (crédit de 10 $ équivalent à envoyer jusqu'à 1 000 messages SMS ou de recevoir jusqu'à 1000 minutes voix entrants, selon le lieu de votre destination de numéro et le message ou appel téléphonique). Racheter ce crédit Twilio et commencer à : [Ahoy.Twilio.com/Azure].
