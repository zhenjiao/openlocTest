...
蔚蓝的客户收到 [特价优惠](http://www.twilio.com/azure): 免费 $10 的应答信用当您升级应答帐户。此应答信用可以应用于任何应答用法 ($10 信贷相当于多达 1000 SMS 封邮件的发送或接收声音入站的达 1000年分钟，取决于您的电话号码和消息或呼叫目的地的位置)。赎回此应答信贷和由此开始: [http://ahoy.twilio.com/azure](http://ahoy.twilio.com/azure).
