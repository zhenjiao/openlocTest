...
Click **セキュリティ** から、 **API の管理** menu on the left, and click **Client certificates**.
...
Click **APIs** から、 **API の管理** menu on the left, click the name of the desired API, and click the **セキュリティ** tab.

![API security][api-management-api-security]

Select **Mutual certificates** から、 **With credentials** drop-down list.
