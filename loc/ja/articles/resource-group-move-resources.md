...
new version is available. For more information, see [インストールし、Azure PowerShell を構成する方法](powershell-install-configure.md).
...
Replace **{source-subscription-id}** と **{source-resource-group-name}** with the subscription and resource group that currently contain the resources you wish to move. Use **2015-01-01** for {api-version}.
