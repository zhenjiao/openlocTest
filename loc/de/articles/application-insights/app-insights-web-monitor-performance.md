...
Make sure your application is performing well, and find out quickly about any failures. [Anwendung-Einblicke][start] will tell you about any performance issues and exceptions, and help you find and diagnose the root causes.
...
> [AZURBLAU. HINWEIS] **Uncheck all the metrics** to see the full selection that is available. The metrics fall into groups; when any member of a group is selected, only the other members of that group appear.
