...
The scenarios covered include **constructing email**, **sending email**和 **adding attachments**. For more information on SendGrid and sending email, see the [接下来的步骤][] 第一节。
...
有关更多信息，请参见 [https://sendgrid.com][].

## <a name="bkmk_CreateSendGrid"> </a>Create a SendGrid Account

[AZURE。包括 [sendgrid-sign-up](../includes/sendgrid-sign-up.md)]
...
## <a name="bkmk_NextSteps"> </a>接下来的步骤
